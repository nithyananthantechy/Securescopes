...
def setup_logging(log_file="logs/nitesentinels.log"):
    """Setup logging to both file and rich console with a serverless read-only fallback."""
    is_serverless = os.environ.get("VERCEL") or os.environ.get("AWS_LAMBDA_FUNCTION_NAME") or os.environ.get("NITESENTINELS_READONLY")
    ...
    return logging.getLogger("nitesentinels")
